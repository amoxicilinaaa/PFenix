...
-- 		["Mega Alakazam"] = {out = 2143, offense = 8.3, defense = 28, specialattack = 5, life = 8000, agility = 220, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},
-- 		["Mega Charizard X"] = { out = {1879, 1880, 1881}, offense = 10.3, defense = 28, specialattack = 5, life = 9000, agility = 260, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},
-- 		["Mega Charizard Y"] = { out = {1876, 1877, 1878}, offense = 9.3, defense = 28, specialattack = 5, life = 9000, agility = 280, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},
-- 		["Mega Blastoise"] = {out = 14, offense = 10.3, defense = 28, specialattack = 5, life = 9000, agility = 260, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},
-- 	    ["Mega Gengar"] = {out = 1851, offense = 15.3, defense = 35, specialattack = 5, life = 9000, agility = 260, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	
	   
-- 		["Mega Ampharos"] = {out = {2093, 2094, 2095}, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	
-- 	    ["Mega Venusaur"] = {out = 1863, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	
-- 	    ["Mega Tyranitar"] = {out = 1854, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	 
-- 		["Mega Kangaskhan"] = {out = 1872, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	
-- 	    ["Mega Scizor"] = {out = 1892, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	
	    
-- 		["Mega Aerodactyl"] = {out = 2061, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	
-- 	    ["Mega Pidgeot"] = {out = 2081, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	
-- 	    ["Mega Mawile"] = {out = 1859, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	
-- 	    ["Mega Gardevoir"] = {out = 2089, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	
-- 	    ["Mega Absol"] = {out = 2068, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	
-- 	    ["Mega Lucario"] = {out = 2069, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	
-- 	    ["Mega Sceptile"] = {out = 2071, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	
-- 	    ["Mega Swampert"] = {out = 2075, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	
-- 	    ["Mega Aggron"] = {out = 1864, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 100, itemToDrop = 19337},	
-- 	    ["Mega Blaziken"] = {out = {2090, 2091, 2092}, offense = 15.3, defense = 28, specialattack = 5, life = 9000, agility = 270, wildVity = 10, wildChance = 0.1, itemToDrop = 19337},	
...
opcodes = {
		...
		OPCODE_PLAYER_SHOW_AUTOLOOT = 33,
...
-- {"Unown Legion", 150, 1801, 1000000},
-- {"Fire Rotom", 150, 1802, 1000000},
-- {"Water Rotom", 150, 1803, 1000000},
-- {"Psychic Rotom", 150, 1804, 1000000},
-- {"Ghost Rotom", 150, 1805, 1000000},
-- {"Grass Rotom", 150, 1806, 1000000},
-- {"Electric Rotom", 150, 1807, 1000000},
...
-- 	},
-- ["Butterfree"] =	{move1 = {name = "", level = 30, cd = 30},
...
-- 	},
-- ["Legiao"] =	{move1 = {name = "Bite", level = 40, cd = 10},
-- 				move2 = {name = "Poison Fang", level = 40, cd = 15},
-- 				move3 = {name = "Gunk Shot", level = 40, cd = 15},
-- 				move4 = {name = "Wrap", level = 40, cd = 20},
-- 				move5 = {name = "Pin Missile", level = 43, cd = 20},
-- 				move6 = {name = "Unown Rush", level = 40, cd = 20},
-- 				move7 = {name = "Iron Tail", level = 40, cd = 20},
-- 				move8 = {name = "Poison Jab", level = 40, cd = 20},
-- 	},	
...
-- 	},
-- ["Venonat"] =	{move1 = {name = "", level = 20, cd = 30},
...
-- 	},
-- ["Venomoth"] =	{move1 = {name = "", level = 50, cd = 35},
...
-- [""] = {target = true, range = 7, power = 0, type = "normal"},
...
priceItemsList = {
	...
	["essence of fire"] = {price = 1},
	["seed"] = {price = 1},
	["bug gosme"] = {price = 1},
	["band aid"] = {price = 1},
	["rubber ball"] = {price = 1},
	["bottle of poison"] = {price = 1},
	["ghost essence"] = {price = 1},
	["dark gem"] = {price = 1},
	["piece of steel"] = {price = 1},
	["straw"] = {price = 1},
	["dragon scale"] = {price = 1},
	["screw"] = {price = 1},
	["enchanted gem"] = {price = 1},
	["earth ball"] = {price = 1},
	["small stone"] = {price = 1},
	["water gem"] = {price = 1},
	["snowball"] = {price = 1},
	...
	["fire pendant"] = {price = 20},
	["venom pendant"] = {price = 18},
	["pot of venom"] = {price = 18},
	["darkness gem"] = {price = 5},
	["essences of darkness"] = {price = 5},
	["magmar foot"] = {price = 1000},
	["arcanine toy"] = {price = 22},
}
