local config = {
	minlevel = 400, --- level inical para resetar
	price = 100000, --- preço inicial para resetar
	newlevel = 20, --- level após reset
	priceByReset = 100000, --- preço acrescentado por reset
	percent = 50, ---- porcentagem da vida/mana que você terá ao resetar 
	maxresets = 50,
	levelbyreset = 25 --- quanto de level vai precisar a mais no próximo reset
}
--- end config
