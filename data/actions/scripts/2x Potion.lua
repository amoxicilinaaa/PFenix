...
local texto = 'Você está com o dobro da experiência por 30 minutos.' -- Texto que irá receber ao usar a potion.
textofinal = 'Sua poção de dobro xp acabou.' -- Texto que irá receber quando o efeito da potion acabar.
