...
spoofPlayers = 2
motd = "Atencao! Baixe o client atualizado (4.7.3) para nao ocorrer nenhum BUG!   (pokemonroxy.servegame.com)"
displayOnOrOffAtCharlist = true
onePlayerOnlinePerAccount = false
allowClones = true
serverName = "RoXy"
loginMessage = "Bem Vindo ao Pokemon Roxy!"
...
rateExperience = 15
premiumrateExperience = 20
ratePremiumExperience = 20
...
experienceShareLevelDifference = 1 * 50
